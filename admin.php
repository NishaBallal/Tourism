...
<head>
	...
	<style>     
		...
		.container .addp-workspace .del-pform {
			display: none; 
			width: 30vw;
			height: 50vh;
			margin: 10% 30%;
		...
		.container .addp-workspace .del-pform input{
			margin: 20px 0px;
		}
	</style>
</head>
<body>
	...
	<div class="container">
		...
		<div class="menu-list">
			...
			<a id="a7" href="#" onclick="myFunction(document.getElementById(this.id))">Delete Place Information</a>
		...
		<div class="addp-workspace work" id="id5" style="display: none;">
			<div class="insert-pform" id="insp-form4">
				<form method="POST" action="admin_op.php">
					...
					<input type="text" name="package" placeholder="Enter package Amount" required><br>
		...
		<div class="addp-workspace work" id="id6" style="display: none;">
			<div class="del-pform" id="insp-form5">
				<form method="POST" action="admin_op.php" >
					<input type="text" name="pname" placeholder="Place Name" required><br>
					<input type="submit" value="Delete Place Details" class="submit" name="del_pd">
				</form>
			</div>
		</div>
